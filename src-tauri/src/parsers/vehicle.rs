                ...
                match tag.as_str() {
                    "vehicle" if !in_vehicle => {
                        ...
                        current_vehicle = Some(VehicleBuilder {
                            unique_id: attr_str(e, "id"),
                            filename,
                            display_name,
                            age: attr_f64(e, "age"),
                            price: attr_f64(e, "price"),
                            farm_id: attr_u8(e, "farmId"),
                            property_state: PropertyState::from_u8(
                                attr_str(e, "propertyState").parse().unwrap_or(0),
                            ),
...
mod tests {
    ...
    fn test_parse_vehicles_nominal() {
        ...
        let tractor = vehicles.iter().find(|v| v.unique_id == "1").unwrap();
